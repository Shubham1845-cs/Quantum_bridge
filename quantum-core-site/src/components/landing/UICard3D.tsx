...
/**
 * 3D UI Card Component
 * From Uiverse.io - Glassmorphic 3D card with hover effects
 */
export default function UICard3D() {
    ...
    <div className="parent">
      <div className="card">
        ...
        <div className="content">
          <span className="title">QUANTUM BRIDGE</span>
          <span className="text">Post-quantum cryptography proxy for legacy systems</span>
        </div>
        <div className="bottom">
          ...
          <div className="view-more">
            <button className="view-more-button" onClick={() => navigate('/dashboard')}>Explore</button>
            <svg
              className="svg"
      ...
      <style jsx>{`
        ...
        .card {
          ...
          box-shadow: rgba(30, 30, 60, 0) 40px 50px 25px -40px,
        ...
        .parent:hover .card {
          ...
          box-shadow: rgba(30, 30, 60, 0.3) 30px 50px 25px -40px,
