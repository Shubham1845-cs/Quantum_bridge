...
export default function DashboardPage() {
  ...
  const handleCreateOrg = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setNewOrgName("");
      fetchOrgs();
      // Optionally navigate directly to the new org
      // navigate(`/org/${newOrg._id}`);
    } catch (err: any) {
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-3">
              <span className="text-gradient-cyan">Command Center</span>
            </h1>
            <p className="text-white/35 text-lg font-light mb-12">
              Manage your quantum network infrastructure
            </p>
          </motion.div>
